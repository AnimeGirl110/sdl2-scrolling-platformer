...
// TYM SAYS:  Config.cpp - Divided the player's walking speed by 100.
// And then multiplied it by 3 for testing purposes.  Remove the 3 multiplier
...
namespace Game::Config
{
  namespace Actor
  {
    ...
    namespace Player
    {
      ...
      float const
          WALKING_SPEED =
              0.000075 * 3.0f; // TYM SAYS: Multiplied by 3 for testing only.
      //TODO: adjust speeds.
